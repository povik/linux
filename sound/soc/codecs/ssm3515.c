...
// TODO: check the mute item is inserted below the low end, not mapped onto it
static DECLARE_TLV_DB_MINMAX_MUTE(ssm3515_dac_volume, -7125, 2400);
...
static const struct snd_kcontrol_new ssm3515_snd_controls[] = {
	...
	SOC_SINGLE("Low EMI Mode Switch", SSM3515_GEC,
		   ffs(SSM3515_GEC_EDGE) - 1, 1, 0), // TODO: replace ffs
	SOC_SINGLE("Soft Volume Ramping Switch", SSM3515_DAC,
		   ffs(SSM3515_DAC_HV) - 1, 1, 1),
	SOC_SINGLE("HPF Switch", SSM3515_DAC,
		   ffs(SSM3515_DAC_HPF) - 1, 1, 0),
	SOC_SINGLE("Low Power Mode Switch", SSM3515_DAC,
		   ffs(SSM3515_DAC_LPM) - 1, 1, 0),
	SOC_SINGLE("DAC Invert Switch", SSM3515_SAI1,
		   ffs(SSM3515_SAI1_DAC_POL) - 1, 1, 0),
};
